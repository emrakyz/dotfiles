# Generated by Powerlevel10k configuration wizard on 2023-11-08 at 02:56 +03.
...
() {
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=255
     ...
     typeset -g POWERLEVEL9K_DIR_PORTAGE_BACKGROUND="4"
     typeset -g POWERLEVEL9K_DIR_PORTAGE_FOREGROUND="254"
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=022
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_FOREGROUND=7
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_BACKGROUND=3
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_FOREGROUND=7
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_BACKGROUND=088
...
function prompt_my_date() {
  p10k segment -f 1 -b 7 -i '📆' -t "%D{%a %d-%m}"
}

function prompt_wttr() {
  weather_output="$(cat "$XDG_CACHE_HOME/weather.txt")"
  p10k segment -f 1 -b 7 -t " $weather_output"
}

function prompt_freeram() {
  free_ram=$(raminfo)
  (( free_ram > 85 )) && p10k segment -f 7 -b 088 -i '🧠' -t "${free_ram}%%" ||
  (( free_ram > 50 )) && p10k segment -f 7 -b 3 -i '🧠' -t "${free_ram}%%" ||
  p10k segment -f 7 -b 028 -i '🧠' -t "${free_ram}%%"
}

function prompt_moon() {
  moonphase="$(cat $XDG_CACHE_HOME/moon.txt)"
  p10k segment -b 7 -t "$moonphase"
}

function prompt_updates() {
  update_count="$(cat $XDG_CACHE_HOME/updates.txt)"

  (( update_count > 0 )) && p10k segment -f 1 -b 055 -t " $update_count"
}
